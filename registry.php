	...
	<div class="span15" style="margin-top:auto; margin-bottom: 25px; margin-left:45px; margin-right: auto;align:center;">
							<table style="background-color: #ffffff;opacity:0.8;align:center;margin-top:40px;margin-right:auto; margin-left:auto;margin-bottom: auto; width:900px;">
								<tbody>
										...
										<br><button class="btn medium orange" style="line-height:18px;font-size:14px;font-weight:lighter;font-family: 'Tahoma', sans-serif;margin-left:0px;margin-top: -20px;align:center;">Contribute to DUMA!</button>
										<p></p><p> <i> Note that contributions are not tax-deductible.</i></p> </td> </tr> 
										</form>  																</br>

										<tr><td style="padding-left:35px;padding-bottom:15px;padding-right:35px;width:900px;font-family: 'Tahoma', sans-serif; margin-left:15px;text-align: justify; color:#444444; font-size: 14px; line-height: 20px;"> We are so excited about DUMA’s potential and would love to make you a part of this experience. Your contribution gives DUMA a better shot at tackling the dire unemployment situation in Kenya, and every little bit counts.  </td> </tr>
 										<tr><td style="padding-left:35px;padding-right:25px;padding-bottom:25px;"> <div class="fb-like" data-href="http://www.dumaworks.com/registry.php" data-send="true" data-width="450" data-show-faces="true"></div></td></tr>

...
<html lang="en">
  <head>
    ...
    <div class="container">
		<div class="content">
			<div class="row" style="margin-top:30px;margin-left:148px;margin-right:148px; margin-bottom:0px; background-color:#ffffff;opacity:0.8; padding:8px;">
						<div class="span15" style="margin-top:0px; margin-bottom: 0px; margin-left:auto; margin-right: auto;align:center;">
							<table style="align:center;margin-top:10px;margin-right:30px; margin-left:30px;margin-bottom: -10px; width:600px;">
								<tbody>
									<tr style="width=100%">
										<td style="width:400px;font-family: 'Tahoma', sans-serif; margin-left:15px;text-align: center; font-weight: lighter; color:#444444; font-size: 25px; line-height: 37px;"> <b> Thanks so much for your support! &nbsp; </b><p></p> </td>  																
 								</tbody>
							</table>
						</div>
						<div class="span15" style="margin-top:0px; margin-bottom: 0px; margin-left:auto; margin-right: auto;align:center;">
							<table style="align:center;margin-top:10px;margin-right:30px; margin-left:30px;margin-bottom: 5px; width:600px;">
								<tbody>
									<tr style="width=100%">
										<td> <img src="images/thanks.jpg"  width="560"> </img></a> </td>
 								</tbody>
							</table>
						</div>

			...
			<? if (isset($_GET["B$@4it"])){?>
				<div class="row" style="width:100%">
					<div class="span12.5" style="background-color:darkorange; margin-left:142px; height: 14px;">
						...
						if ($errno == 1) { echo "Location, age and gender are required fields";} 
			...
			<div class="row" style="margin-left: 0px";>
					<div class="span16">
						...
						<div class="row " style="margin-left: -10px; margin-bottom: 0px; ">
							...
							$info = mysql_query("SELECT * FROM `meta` WHERE `user_id` = '$userid'") or die (mysql_error());
							$user_data = mysql_fetch_assoc($info);
							$given_email = $user_data['email'];
							$given_location = $user_data['location'];
							$given_age = $user_data['age']; 
							$given_gender = $user_data['gender'];
							$edu_primary  = $user_data['edu_primary'];
							$edu_secondary 	 = $user_data['edu_secondary'];
							$edu_university  = $user_data['edu_university'];
							$edu_technical 	 = $user_data['edu_technical'];
							
							?>
								<form action="process_generalInfo.php" method="POST" class="pull-left">	
									<table width="350px" style="margin-bottom: 5px;">
										<tbody>
											<tr>
												<td align="right" valign="middle" height="100%" style="vertical-align:middle;"> Email </td>
												<td font=""> <input class="input-xlarge" name="email" type="text" value="<?if($given_email) {echo "$given_email"; }?>"> </input></td>
											</tr>
											<tr>
												...
												echo "<option value=\"$location\""; if($given_location == $location){echo" SELECTED ";} echo"> $location </option>"; 
												}
												?>
												</select>
												</td>
											...
											<tr>
												<td align="right" valign="middle" height="100%" style="vertical-align:middle;"> Age (in years) </td>
												<td> <input class="input-xlarge" name="age_select" type="text" value="<?if($given_age){echo "$given_age"; }?>"> </input></td>
											</tr>
											<tr>
												...
												<option> </option>
												<option value="male" <?if($given_gender == 'male'){echo " SELECTED ";}?>> Male </option>
												<option value="female" <?if($given_gender == 'female'){echo " SELECTED ";}?>> Female </option>
												</select>
												</td>
											</tr>
											<tr>
												...
												<table style="opacity:0.75;filter:alpha(opacity=75);">
													<tbody>
														<tr>
															<td>
																<input type="checkbox" name="edu_primary" value="1" <?if($edu_primary == '1'){ echo " CHECKED"; }?>/> Primary School
															</td>
														</tr>
														<tr>
															<td>
																<input type="checkbox" name="edu_secondary" value="1" <?if($edu_secondary == '1'){ echo " CHECKED"; }?>/> Secondary School
															</td>
														</tr>
														<tr>
															<td>
																<input type="checkbox" name="edu_university" value="1" <?if($edu_university == '1'){ echo " CHECKED"; }?>/> University
															</td>
														</tr>
														<tr>
															<td>
																<input type="checkbox" name="edu_technical" value="1" <?if($edu_technical == '1'){ echo " CHECKED"; }?>/> Technical School
															</td>
														</tr>

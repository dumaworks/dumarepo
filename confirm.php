			...
			<div class="row" style="margin-left: 0px";>
					<div class="span16">
						<div class="row " style="margin-left: -10px; margin-bottom: 0px">
							...
							else if ($phone_number && !isset($_GET["B$@4it"])) {echo "Your account has been created! Please enter the 4 digit code sent to $phone_number to confirm your account"; } 
							else { echo "Confirm your account";}?></h4>
							</div>
						</div>
						<? if (isset($_GET["B$@4it"])){?> <div class="row" style="width:100%;">
						<div class="alert-message warning" style="background-color:orange; margin-left:150px; height: 25px;">
							...
							else if ($errno == 3) { echo "Error: The phone number could not be found";} 
							?></p></td></tr></table>
							</div>
						</div><?}?>
									...
									<table width="350px">
										<tbody>
											...
											<tr>
												...
												<td> <button class="btn large orange" type="submit">Resend Confirmation code</button></td>
											</tr>
										</tbody>
									</table>	
								</form>
